  ...
  function displayRepositories(){
    ...
    finalcontent.innerHTML+='<tr>'+'<td '+repostring+'<h4 id="tabledoc">'+repo.full_name+'</h4>'+'</td>'+'</tr>';
    });
    });
  }
    ...
    function displayIssue(issuesopen){
      ...
      finalcontent.innerHTML+='<tr>'+'<td>'+issuestring+'&nbsp&nbsp&nbsp'+'<strong style="font-size:14px">'+issue.title+'</strong>'+'</td>'+'</tr>';
      getlabel(issue);
      });
    }
    ...
    function displayUserrepos(responsedata){
      var data = responsedata;
      finalcontent.innerHTML = '<h3>'+data[0].owner.login+"'s "+'repositories'+'<h3>';
      data.forEach(function(repo){
      var userrepostr = '<span class="userrepo">repo</span>';
      finalcontent.innerHTML+='<tr><td>'+userrepostr+ '&nbsp&nbsp&nbsp&nbsp' +'<span class="finalrepo">'+repo.name+'</span>'+'</td></tr>';
      });
    }
    ...
    function getlabel(issue){
      ...
      var labelstring = '<span class="ilabel" style="background-color:#'+label.color +'">'+label.name+'</span>';
